            ...
            <div class="container">
                ...
                <div class="nav-collapse">
                    ...
                    $this->widget('zii.widgets.CMenu', array(
                        ...
                        'encodeLabel' => false,
                        'items' => array(
                            array('label' => 'Inventori', 'url' => array('/produk/admin'),'linkOptions' => array("data-description" => "Manage Barang")),                           
                            array('label' => 'Transaksi <span class="caret"></span>', 'url' => array('/site/page', 'view' => 'columns'), 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown", "data-description" => "Lakukan Peminjaman Atau Pengembalian"),
                                'items' => array(
                                    array('label' => 'Issue', 'url' => array('/issue/create')),
                                    array('label' => 'Return', 'url' => array('/returns/create')),
                            )),
                            array('label' => 'Daftar Transaksi<span class="caret"></span>', 'url' => array('/site/page', 'view' => 'portfolio-4-cols'),'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown", "data-description" => "Daftar Peminjaman dan Pengembalian"),
                                'items' => array(
                                    array('label' => 'Datar Issue', 'url' => array('/issue/admin')),
                                    array('label' => 'Daftar Return', 'url' => array('/returns/admin')),
                                    )),                            
